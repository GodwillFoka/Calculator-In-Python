...
#adding oder button to calculator
...
Button(root, text="+",command = lambda:get_operaton("+")).grid(row=2, column=3)
Button(root, text="-",command = lambda:get_operaton("*")).grid(row=3, column=3)
Button(root, text="*",command = lambda:get_operaton("*")).grid(row=4, column=3)
Button(root, text="/",command = lambda:get_operaton("/")).grid(row=5, column=3)

#adding new operations 
Button(root, text="pi",command = lambda:get_operaton("*3.14")).grid(row=2, column=4)
Button(root, text="%",command = lambda:get_operaton("%")).grid(row=3, column=4)
Button(root, text="(",command = lambda:get_operaton("(")).grid(row=4, column=4)
Button(root, text="exp",command = lambda:get_operaton("**")).grid(row=5, column=4)

Button(root, text="<-",command = lambda:undo()).grid(row=2, column=5)
Button(root, text="x!").grid(row=3, column=5)
Button(root, text=")",command = lambda:get_operaton(")")).grid(row=4, column=5)
Button(root, text="^2",command = lambda:get_operaton("**2")).grid(row=5, column=5)
